...
require("ssl-root-cas").addFile(__dirname+"/../ssl/e73273e53acfe80f410b3ef46b180287a00440cd.pem").inject();
...
elevents.prototype.update = function(){
	...
	request({
		...
		headers: {
			"user-agent": "Liftstream/1", // strangely, the api requires a user agent
